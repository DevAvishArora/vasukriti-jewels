        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #d97706 0%, #e11d48 100%); padding: 40px 30px; text-align: center;">
              <h1 style="margin: 0; color: #ffffff; font-size: 28px; font-weight: 700;">Vasukriti Jewels</h1>
            ...
            <td style="padding: 40px 30px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 24px;">
                <tr>
                  ...
                  <td style="padding: 8px 0; text-align: right; color: #1f2937;">₹${order.itemsPrice.toLocaleString()}</td>
                </tr>
                <tr>
                  <td style="padding: 8px 0; color: #6b7280;">Shipping</td>
                  <td style="padding: 8px 0; text-align: right; color: #1f2937;">₹${order.shippingPrice.toLocaleString()}</td>
                </tr>
                <tr>
                  <td style="padding: 8px 0; color: #6b7280;">Tax</td>
                  <td style="padding: 8px 0; text-align: right; color: #1f2937;">₹${order.taxPrice.toLocaleString()}</td>
                </tr>
                ${
                ...
                <tr>
                  ...
                  <td style="padding: 8px 0; text-align: right; color: #059669;">-₹${order.discountAmount.toLocaleString()}</td>
                </tr>
                `
                    : ''
                }
                <tr style="border-top: 2px solid #e5e7eb;">
                  ...
                  <td style="padding: 16px 0 0 0; text-align: right; color: #d97706; font-size: 20px; font-weight: 700;">₹${order.totalPrice.toLocaleString()}</td>
                </tr>
              </table>
          ...
          <tr>
            <td style="background-color: #f9fafb; padding: 30px; text-align: center; border-top: 1px solid #e5e7eb;">
              ...
              <p style="margin: 0; color: #9ca3af; font-size: 12px;">
                © ${new Date().getFullYear()} Vasukriti Jewels. All rights reserved.
              </p>
            </td>
          </tr>
        </table>
            ...
            <td style="padding: 40px 30px;">
              ...
              <div style="background-color: #fef2f2; border-left: 4px solid #dc2626; padding: 16px; margin-top: 24px; border-radius: 4px;">
                <p style="margin: 0; color: #991b1b; font-size: 14px; line-height: 1.6;">
                  <strong>Security Tip:</strong> Never share your password reset link with anyone. Vasukriti Jewels will never ask for your password via email.
                </p>
              </div>
            </td>
          </tr>
...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Welcome to Vasukriti Jewels</title>
</head>
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f3f4f6;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f3f4f6; padding: 40px 20px;">
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #d97706 0%, #e11d48 100%); padding: 40px 30px; text-align: center;">
              <h1 style="margin: 0; color: #ffffff; font-size: 32px; font-weight: 700;">Welcome to Vasukriti Jewels!</h1>
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 16px 0; color: #6b7280; font-size: 16px; line-height: 1.6;">
                Thank you for joining Vasukriti Jewels! We're thrilled to have you as part of our community.
              </p>
              <p style="margin: 0 0 24px 0; color: #6b7280; font-size: 16px; line-height: 1.6;">
