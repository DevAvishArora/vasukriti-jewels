...
export default function StaticContentPage() {
  ...
  const fetchAllSections = async () => {
    try {
      const response = await axiosInstance.get('/cms/static');
  ...
  const fetchSection = async (sectionKey: string) => {
    try {
      setLoading(true);
      const response = await axiosInstance.get(`/cms/static/${sectionKey}`);
  ...
  const handleSave = async () => {
    ...
    try {
      setLoading(true);
      await axiosInstance.post('/cms/static', editingContent);
  ...
  const handlePublish = async () => {
    ...
    try {
      setLoading(true);
      await axiosInstance.post(`/cms/static/${editingContent._id}/publish`);
