...
export function ProductFilters({ filters, onFilterChange, onClearFilters, maxPrice }: ProductFiltersProps) {
        ...
        {expandedSections.price && (
          <div className="space-y-4">
            <Slider
              ...
              max={maxPrice}
              step={1000}
              className="w-full [&_[role=slider]]:bg-[#7e1219] [&_[role=slider]]:border-[#7e1219] [&_.bg-primary]:bg-[#7e1219]"
            />
